...
#include "ArtOfRallyOffroadCar.h"
#include "ArtOfRallyOffroadWheelFront.h"
#include "ArtOfRallyOffroadWheelRear.h"
...
AArtOfRallyOffroadCar::AArtOfRallyOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UArtOfRallyOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UArtOfRallyOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UArtOfRallyOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UArtOfRallyOffroadWheelRear::StaticClass();
