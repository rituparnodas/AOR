...
#include "ArtOfRallySportsCar.h"
#include "ArtOfRallySportsWheelFront.h"
#include "ArtOfRallySportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AArtOfRallySportsCar::AArtOfRallySportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UArtOfRallySportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UArtOfRallySportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UArtOfRallySportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UArtOfRallySportsWheelRear::StaticClass();
